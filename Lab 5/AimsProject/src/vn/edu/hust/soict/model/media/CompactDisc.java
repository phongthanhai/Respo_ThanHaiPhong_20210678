...
public class CompactDisc extends Disc implements Playable{
	...
	public CompactDisc(int id, String title,String category,String director,float cost, float length,ArrayList<Track> tracks) {
	...
	public CompactDisc(String title,String category,float cost, String string, ArrayList<Track> cd1Tracks) {
		super(title,category,cost);
	}
